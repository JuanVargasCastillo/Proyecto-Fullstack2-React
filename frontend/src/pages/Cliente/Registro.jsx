        ...
        <div className="col-md-6">
          <form id="formRegistro" onSubmit={onSubmit}>
            ...
            <div className="mb-3">
              ...
              <input type="email" className="form-control" id="correo" value={email} onChange={(e) => setEmail(e.target.value)} required />
            </div>
            ...
            <div className="mb-3">
              ...
              <div id="mensajePassword" className="fw-bold mt-1">{mensajePassword}</div>
            </div>

            <div className="mb-3">
              <label htmlFor="telefono" className="form-label">Teléfono:</label>
              <input type="text" className="form-control" id="telefono" value={telefono} onChange={(e) => setTelefono(e.target.value)} placeholder="9 dígitos" />
            </div>
            ...
            <div className="text-center">
              <input type="submit" value="Registrar Usuario" className="btn btn-registrar me-2" />
